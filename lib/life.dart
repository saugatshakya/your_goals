...
class _LifeState extends State<Life> with SingleTickerProviderStateMixin{
  Future _openBox() async {
    await Hive.openBox('lifegoals');
    await Hive.openBox('laban');
    return;
  }
  List<bool> state = [true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true];
  void addgoal(Goal goal) {
    Hive.box('lifegoals').add(goal);
  }
  void compgoal(Goal goal){
    Hive.box('lcomp').add(goal);
  }
  void abangoal(Goal goal){
    Hive.box('laban').add(goal);
  }
            ...
            child:Column(children:[
             ...
             Container(
              ...
              decoration: BoxDecoration(color:Colors.black45,borderRadius:BorderRadius.only(topLeft:Radius.circular(20),bottomLeft:Radius.circular(20))),
                ...
                FlatButton(onPressed:(){Navigator.pushNamed(context,'/life');} ,color:Colors.black45,child: Container(width: 230,padding:EdgeInsets.fromLTRB(20,5,0,5),child: Row(children: [Icon(Icons.playlist_add_check,color:Colors.white),SizedBox(width: 10),Text('Life Goals',style: TextStyle(color:Colors.white,fontSize: 18))]))),
          ],),
            ),
            Container(
              decoration: BoxDecoration(color:Colors.black45,borderRadius:BorderRadius.only(topLeft:Radius.circular(20),bottomLeft:Radius.circular(20))),
...
Widget dailygoals(context) {
  final goalBox = Hive.box('lifegoals');
  final compBox = Hive.box('lcomp');
  final abanBox = Hive.box('laban');
    return 
      AnimatedPositioned(
        ...
        right:  isCollapsed?0:-0.4*screenWidth,
          child: ScaleTransition(
            ...
            bottomNavigationBar: BottomAppBar(shape: CircularNotchedRectangle(),color: Colors.black87,child: Container(padding:EdgeInsets.fromLTRB(20,0,20,0) ,height: 50,child:Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,children: <Widget>[GestureDetector(onTap: (){Navigator.pushNamed(context, '/lcomp');},child: Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly,children: [Text('Completed Goals',style: TextStyle(color:Colors.white,fontSize:14),),Text(compBox.length.toString(),style: TextStyle(color:Colors.white,fontSize:14))])),Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly,children: [Text('Abandoned Goals',style: TextStyle(color:Colors.white,fontSize:14)),Text(abanBox.length.toString(),style: TextStyle(color:Colors.white,fontSize:14))])],)),notchMargin:4,),
              body: SizedBox(
                child:Container(
                  decoration: BoxDecoration(gradient: LinearGradient(
                    colors: [Colors.indigo[900],Colors.purple],
                  ...
                  child: Column(
                    children: <Widget>[
                      Container(margin:EdgeInsets.fromLTRB(0, 30, 0, 0),child: Row(children: [SizedBox(width: 5),InkWell(child:Icon(Icons.menu,color: Colors.lightBlue[200],size: 30),onTap:() { 
                        ...
                        SizedBox(width: 80),Text('Life Goals',style: TextStyle(shadows: [Shadow(blurRadius: 25.0,color: Colors.blue[800],offset: Offset(12.0, 12.0),),] , fontSize: 40,letterSpacing: 3,fontWeight: FontWeight.bold,color:Colors.white,fontFamily: 'Caveat'))])),
                      ...
                      Expanded(
                        child: Row(
                            ...
                            decoration: BoxDecoration(color: Colors.black26,borderRadius:BorderRadius.only(topLeft:Radius.circular(15),bottomLeft:Radius.circular(15))),height:state[index]?65:110,
                              ...
                              compBox.length==15?showDialog(context:context,builder:(BuildContext context){return AlertDialog(content: SizedBox(height:50,child: Center(child: Text('You have a new achievement'))));}):SizedBox();
                              ...
                              compBox.length==25?showDialog(context:context,builder:(BuildContext context){return AlertDialog(content: SizedBox(height:50,child: Center(child: Text('You have a new achievement'))));}):SizedBox();
                              compBox.length==30?showDialog(context:context,builder:(BuildContext context){return AlertDialog(content: SizedBox(height:50,child: Center(child: Text('You have a new achievement'))));}):SizedBox();
