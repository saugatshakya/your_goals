...
class Daban extends StatefulWidget {
  @override
  _DabanState createState() => _DabanState();
}

class _DabanState extends State<Daban> with SingleTickerProviderStateMixin{
      ...
      crossAxisAlignment: CrossAxisAlignment.start,
        ...
        child: Row(
          mainAxisAlignment: MainAxisAlignment.start,
                  children: [
                Container(margin: EdgeInsets.fromLTRB(0,40,0,0),child: IconButton(icon: Icon(Icons.chevron_left),color: Colors.white38, onPressed:(){Navigator.pushNamed(context,'/dcomp');})),
                Container(
                width: 264,
                child: Column(
