...
class Laban extends StatefulWidget {
  @override
  _LabanState createState() => _LabanState();
}

class _LabanState extends State<Laban> with SingleTickerProviderStateMixin{
      ...
      crossAxisAlignment: CrossAxisAlignment.start,
        ...
        child: Row(
          mainAxisAlignment: MainAxisAlignment.start,
                  children: [
                Container(margin: EdgeInsets.fromLTRB(0,40,0,0),child: IconButton(icon: Icon(Icons.chevron_left),color: Colors.white38, onPressed:(){Navigator.pushNamed(context,'/lcomp');})),
                Container(
                width: 264,
                child: Column(
