...
class Yaban extends StatefulWidget {
  @override
  _YabanState createState() => _YabanState();
}

class _YabanState extends State<Yaban> with SingleTickerProviderStateMixin{
...
Widget dailygoals(context) {
  final goalBox = Hive.box('yaban');
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
        ...
        child: Row(
          mainAxisAlignment: MainAxisAlignment.start,
                  children: [
                Container(margin: EdgeInsets.fromLTRB(0,40,0,0),child: IconButton(icon: Icon(Icons.chevron_left),color: Colors.white38, onPressed:(){Navigator.pushNamed(context,'/ycomp');})),
                Container(
                width: 264,
                child: Column(
      ...
      ),Container(margin: EdgeInsets.fromLTRB(0,38,0,0),child: IconButton(icon: Icon(Icons.home),iconSize:32, onPressed:(){Navigator.popAndPushNamed(context,'/yearly');}))
          ]);}}