...
class Dcomp extends StatefulWidget {
  @override
  _DcompState createState() => _DcompState();
}

class _DcompState extends State<Dcomp> with SingleTickerProviderStateMixin{
...
Widget dailygoals(context) {
  final goalBox = Hive.box('dcomp');
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Container(margin: EdgeInsets.fromLTRB(0,38,0,0),child: IconButton(icon: Icon(Icons.home),iconSize:32, onPressed:(){Navigator.popAndPushNamed(context,'/home');})),
            Container(
              width: 312,
        ...
        child: Row(
          mainAxisAlignment: MainAxisAlignment.start,
                ...
                Container(margin: EdgeInsets.fromLTRB(0,40,0,0),child: IconButton(icon: Icon(Icons.chevron_right),color: Colors.white38, onPressed:(){Navigator.pushNamed(context,'/daban');}))]),
      ),
          ]);}}