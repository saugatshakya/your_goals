...
class Wcomp extends StatefulWidget {
  @override
  _WcompState createState() => _WcompState();
}

class _WcompState extends State<Wcomp> with SingleTickerProviderStateMixin{
      ...
      crossAxisAlignment: CrossAxisAlignment.start,
        ...
        child: Row(
          mainAxisAlignment: MainAxisAlignment.start,
                ...
                Container(margin: EdgeInsets.fromLTRB(0,40,0,0),child: IconButton(icon: Icon(Icons.chevron_right),color: Colors.white38, onPressed:(){Navigator.pushNamed(context,'/waban');}))]),
      ),
          ]);}}