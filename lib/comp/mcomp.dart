...
class Mcomp extends StatefulWidget {
  @override
  _McompState createState() => _McompState();
}

class _McompState extends State<Mcomp> with SingleTickerProviderStateMixin{
      ...
      crossAxisAlignment: CrossAxisAlignment.start,
        ...
        child: Row(
          mainAxisAlignment: MainAxisAlignment.start,
                ...
                Container(margin: EdgeInsets.fromLTRB(0,40,0,0),child: IconButton(icon: Icon(Icons.chevron_right),color: Colors.white38, onPressed:(){Navigator.pushNamed(context,'/maban');}))]),
      ),
          ]);}}